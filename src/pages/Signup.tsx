...
export const Signup = () => {
  ...
  const msg = validationError || (error ? String(error) : '');
    ...
    <div className="min-h-screen bg-bg text-ink flex items-center justify-center px-4">
      <div className="w-full max-w-[360px] border border-line">
        ...
        <form onSubmit={handleSubmit} className="p-5 flex flex-col gap-4">
          <div className="text-center label-caps">Create account</div>
          {msg && <div className="border border-ask/40 bg-ask/10 text-ask text-[11px] mono p-2">{msg}</div>}
